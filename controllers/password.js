...
module.exports.forgotPassword = async (req, res) => {
  try {
    ...
    sendSmtpEmail.htmlContent =
      "<html><body><h3>{{params.parameter}}</h3> <p>{{params.link}}<P></body></html>";
    sendSmtpEmail.sender = {
      name: "kumaran",
      email: "kumaranselvaraj07@gmail.com",
    };
...
module.exports.resetPassword = async (req, res) => {
  try {
    ...
    if (requestid.isActive === true) return res.status(200).sendFile(resetform);
